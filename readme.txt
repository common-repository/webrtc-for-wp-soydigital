...
To receive calls you need to sign on the service in http://www.soydigital.com/plugin/webrtc-wp-form/  
...
= 1.1 =
* Fix any problem whit compatibilities in some others plugins

= 1.2 =
* Fix css problems whit https webrtc access